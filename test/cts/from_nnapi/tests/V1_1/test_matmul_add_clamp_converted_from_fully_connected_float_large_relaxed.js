...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test matmul + add + clamp converted from fully_connected_float_large_relaxed test', async () => {
    ...
    const op2 = builder.constant({dataType: 'float32', dimensions: [5, 1]}, new Float32Array([2, 3, 4, 5, 6]));
    const b0 = builder.constant({dataType: 'float32', dimensions: [1]}, new Float32Array([900]));
    const expected = [9832];
