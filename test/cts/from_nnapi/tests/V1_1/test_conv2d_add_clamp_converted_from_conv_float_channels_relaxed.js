...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test conv2d + add + clamp converted from conv_float_channels_relaxed test', async () => {
    ...
    const op2 = builder.constant({dataType: 'float32', dimensions: [3, 1, 1, 3]}, new Float32Array([1.0, 1.0, 1.0, 2.0, 2.0, 2.0, 3.0, 3.0, 3.0]));
    const op3 = builder.constant({dataType: 'float32', dimensions: [3]}, new Float32Array([0.0, 0.0, 0.0]));
    const pad0 = 0;
    const stride = 1;
