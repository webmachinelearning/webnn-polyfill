...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test matmul + add + clamp converted from fully_connected_float_weights_as_inputs_relaxed test', async () => {
    ...
    const op2 = builder.input('op2', {dataType: 'float32', dimensions: [1, 1]});
