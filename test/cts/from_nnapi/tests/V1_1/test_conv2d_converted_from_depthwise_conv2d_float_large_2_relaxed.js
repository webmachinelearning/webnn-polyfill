...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test conv2d (fused ops) converted from depthwise_conv2d_float_large_2_relaxed test', async () => {
    ...
    const op3 = builder.constant({dataType: 'float32', dimensions: [4]}, new Float32Array([6000, 7000, 8000, 9000]));
    const pad0 = 0;
    const stride = 1;
