...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test conv2d (fused ops) converted from depthwise_conv2d_float_large_weights_as_inputs_relaxed test', async () => {
    ...
    const op2 = builder.input('op2', {dataType: 'float32', dimensions: [1, 2, 2, 2]});
    const op2Data = new Float32Array([0.25, 0, 0.25, 1, 0.25, 0, 0.25, 1]);
    const op3 = builder.input('op3', {dataType: 'float32', dimensions: [2]});
