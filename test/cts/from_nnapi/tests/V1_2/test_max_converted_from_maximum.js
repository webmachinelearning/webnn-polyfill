...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test max converted from maximum_simple test', function() {
  ...
  it('test max converted from maximum_simple_relaxed test', function() {
    // Converted test case (from: V1_2/maximum.mod.py)
    const builder = new MLGraphBuilder(context);
    const input0 = builder.input('input0', {type: 'float32', dimensions: [3, 1, 2]});
    const input0Data = new Float32Array([1.0, 0.0, -1.0, 11.0, -2.0, -1.44]);
  ...
  it('test max converted from maximum_simple_int32 test', function() {
    // Converted test case (from: V1_2/maximum.mod.py)
    const builder = new MLGraphBuilder(context);
  ...
  it('test max converted from maximum_broadcast test', function() {
    // Converted test case (from: V1_2/maximum.mod.py)
    const builder = new MLGraphBuilder(context);
  ...
  it('test max converted from maximum_broadcast_relaxed test', function() {
    // Converted test case (from: V1_2/maximum.mod.py)
    const builder = new MLGraphBuilder(context);
    const input01 = builder.input('input01', {type: 'float32', dimensions: [3, 1, 2]});
    const input01Data = new Float32Array([1.0, 0.0, -1.0, -2.0, -1.44, 11.0]);
  ...
  it('test max converted from maximum_broadcast_int32 test', function() {
    // Converted test case (from: V1_2/maximum.mod.py)
    const builder = new MLGraphBuilder(context);
