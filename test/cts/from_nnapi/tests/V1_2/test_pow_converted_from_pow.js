...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test pow converted from pow test', async () => {
    ...
    const base = builder.input('base', {dataType: 'float32', dimensions: [2, 1]});
    const baseData = new Float32Array([2.0, 3.0]);
    const exponent = builder.input('exponent', {dataType: 'float32', dimensions: [1]});
  ...
  it('test pow converted from pow_2 test', async () => {
    ...
    const base = builder.input('base', {dataType: 'float32', dimensions: [2, 1]});
    const baseData = new Float32Array([2.0, 3.0]);
    const exponent1 = builder.input('exponent1', {dataType: 'float32', dimensions: [1, 2]});
  ...
  it('test pow converted from pow_3 test', async () => {
    ...
    const base = builder.input('base', {dataType: 'float32', dimensions: [2, 1]});
    const baseData = new Float32Array([2.0, 3.0]);
    const exponent2 = builder.input('exponent2', {dataType: 'float32', dimensions: [3, 1, 2]});
