...
describe('CTS converted from NNAPI CTS', () => {
  ...
  it('test conv2d + add + clamp converted from depthwise_conv2d_float_large_2 test', async () => {
    ...
    const op2 = builder.constant({dataType: 'float32', dimensions: [1, 2, 2, 4]}, new Float32Array([0.25, 0, 10, 100, 0.25, 1, 20, 100, 0.25, 0, 30, 100, 0.25, 1, 40, 100]));
    const op3 = builder.constant({dataType: 'float32', dimensions: [4]}, new Float32Array([600000, 700000, 800000, 900000]));
    const pad0 = 0;
    const stride = 1;
